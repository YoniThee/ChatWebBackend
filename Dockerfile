...
COPY . .
WORKDIR "/src/ChatWeb"
RUN dotnet build "./ChatWeb.csproj" -c $BUILD_CONFIGURATION -o /app/build

# This stage is used to publish the service project to be copied to the final stage
FROM build AS publish
ARG BUILD_CONFIGURATION=Release
RUN dotnet publish "./ChatWeb.csproj" -c $BUILD_CONFIGURATION -o /app/publish /p:UseAppHost=false
